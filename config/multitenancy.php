...
return [
    ...
    /*
     * These fields are used by the domain tenant finder to find a tenant.
     */
     ...
     */
    'make_tenant_current_task' => \Spatie\Multitenancy\Tasks\SwitchTenantDatabaseTask::class,
    ...
    'switch_tenant_tasks' => [
        ...
        \App\Tasks\ForceDefaultTenantConnectionTask::class,
    ],
